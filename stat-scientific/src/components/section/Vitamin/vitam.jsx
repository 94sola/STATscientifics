...
import chromatographyImg from "../../../assets/images/vitamins.jpg";
import { Link } from "react-router-dom";

export default function Vitamin() {
return ( 
    <section className="w-full font-manrope"> <div className="grid min-h-105 grid-cols-1 lg:grid-cols-2">

      { /* LEFT */}
        <div className="bg-gray-300 flex items-center justify-center px-8 sm:px-12 lg:px-20"> <div className="max-w-3xl"> 
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-tight text-neutral-900">
            Quantitative Vitamin <br /> Analysis 
            </h1>
            ...
            Reliable quantification of essential vitamins in food,
            supplements, and biological samples.
            </p>
