...
const faqs = [
{
question: "Which vitamins can you analyse?",
answer:
"We provide targeted quantitative analysis of selected vitamins using validated analytical methods. The specific vitamin panel depends on the sample type and analytical requirements of the project.",
},
{
question: "Can you analyse vitamins in food and supplements?",
answer:
"Yes. Vitamin analysis can be performed on a range of food products, dietary supplements, plant-based materials, and other suitable sample matrices.",
},
{
question: "Do you identify every vitamin present?",
answer:
"No. Our service focuses on targeted quantification of validated vitamins within the scope of the selected analytical method. We report the vitamins covered by the method rather than assigning identities to unknown compounds.",
},
{
question: "Can additional vitamins be added to the analysis?",
answer:
"Yes. Additional vitamins may be considered based on customer requirements, sample characteristics, analytical feasibility, and method validation requirements.",
},
];
