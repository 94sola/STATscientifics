    ...
    <div className="grid min-h-115 grid-cols-1 lg:grid-cols-2 ">
      ...
      { /* LEFT */}
        <div className="bg-gray-300 flex items-center justify-center px-8 sm:px-12 lg:px-20 py-10 sm:py-12 lg:py-16"> 
            ...
            Comprehensive Fatty Acid <br />& Trans Fat Analysis 
            </h1>
            <div className="w-32 h-px bg-gray-800/70 mt-6 mb-10"></div>

            <p className="mb-3 max-w-3xl text-lg md:text-xl lg:text-2xl font-light tracking-tight text-neutral-900">
            Our laboratory quantifies 37 fatty acid methyl esters (FAMEs) using authenticated reference standards and a GC-FID, delivering
            exceptional separation of saturated, unsaturated and trans fatty acids. <br />
            </p>
            <p className="mb-10 max-w-3xl text-lg md:text-xl lg:text-2xl font-light tracking-tight text-neutral-900">
            We also provide Trans Fatty Acid (TFA) determination in accordance with the World Health Organization (WHO) laboratory protocol for food surveillance and regulatory monitoring. 
            </p>
